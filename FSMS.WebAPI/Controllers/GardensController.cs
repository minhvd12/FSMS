...
namespace FSMS.WebAPI.Controllers
{
    ...
    public class GardensController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetAllGardens(string? gardenName = null, bool activeOnly = false)
        {
            try
            {
                List<GetGarden> gardens = await _gardenService.GetAllAsync(gardenName, activeOnly);
                return Ok(new
                {
                    Data = gardens
                });
